...
将 vitegame 的 React 19 + Tailwind CSS UI 迁移到 newguild 的 Godot Control 节点系统，保持功能等价性与可测试性。

---

## 技术栈对比

| 层次 | vitegame (Web) | newguild (Godot) |
|-----|---------------|------------------|
