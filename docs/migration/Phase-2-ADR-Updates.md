...
### ADR-0024: Godot Test Strategy (TDD + GdUnit4)
...
| 旧预加载脚本 白名单 | Autoload 单例白名单 | project.godot [autoload] 受控 |
...
**文件路径**: `docs/adr/ADR-0024-godot-test-strategy.md`
