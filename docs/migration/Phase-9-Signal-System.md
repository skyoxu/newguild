...
将 vitegame 的 CloudEvents 事件系统迁移到 newguild 的 Godot Signals，建立类型安全的信号架构与跨场景通信模式。
...
| 功能 | vitegame (CloudEvents) | newguild (Godot Signals) |
|-----|----------------------|--------------------------|
...
**Godot EventBus Autoload (newguild)**:
