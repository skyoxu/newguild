...
> **核心目标**：逐功能对标验证 vitegame 与 newguild 的特性一致性，建立功能完整性与兼容性验收基线。
> **工作量**：5-7 人天
...
| 功能模块 | vitegame 实现 | newguild 对标 | 验收标准 |
|---------|-------------|---------------|---------|
...
| **数据导入** | - | 迁移脚本 | vitegame 数据可导入 newguild |

#### 维度 D: 性能基线对标（Performance Baseline）

| 性能指标 | vitegame 基线 | newguild 目标 | 验收标准 |
|--------|-------------|--------------|---------|
...
**职责**：
- 逐功能列出 vitegame vs newguild 的对标要点
- 记录每个功能的验收状态
- 作为发版前的最终检查清单
