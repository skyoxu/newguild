...
func test_roster_actions_update_member_list_via_events() -> void:
	...
	var user_id_input: LineEdit = panel.get_node("VBox/RosterActions/UserIdRow/UserIdInput")
	var join_button: Button = panel.get_node("VBox/RosterActions/MemberActionsRow/JoinButton")
	var leave_button: Button = panel.get_node("VBox/RosterActions/MemberActionsRow/LeaveButton")
	var promote_button: Button = panel.get_node("VBox/RosterActions/MemberActionsRow/PromoteButton")
	var demote_button: Button = panel.get_node("VBox/RosterActions/MemberActionsRow/DemoteButton")
	var kick_button: Button = panel.get_node("VBox/RosterActions/MemberActionsRow/KickButton")
