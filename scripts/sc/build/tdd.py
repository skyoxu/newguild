...
def run_refactor_checks(out_dir: Path, *, task_id: str) -> list[dict[str, Any]]:
    ...
    candidates = [
        ...
        (
            "check_task_contractrefs_coverage",
            ["py", "-3", "scripts/python/check_task_contractrefs_coverage.py", "--task-id", str(task_id), "--view", "auto", "--strict"],
            "scripts/python/check_task_contractrefs_coverage.py",
        ),
